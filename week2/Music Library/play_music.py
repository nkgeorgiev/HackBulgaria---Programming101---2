...
def playSong(mp3s, index):
    ...
    while(index < len(mp3s)):
        try:
            os.system("gnome-terminal -e 'play {}';sleep {}".format(mp3s[index].path, mp3s[index].length+1))
...
def playSong(mp3s, index):
    ...
    while(index < len(mp3s)):
        #print("gnome-terminal -e 'play "+mp3s[index].path+"; sleep "+mp3s[index].length+"'")
        #"gnome-terminal -e 'play {}; sleep {}'"
        try:
